...
from .views import (hello, huan_tshiat_huat, tshue_han_ji_e_sip_ngoo_im,
                    tshue_han_ji_e_tai_lo_phing_im, tshue_han_ji_huat_im)
...
urlpatterns = [
    ...
    # # 查漢字方音符號發音
    # path('gtshue_han_ji_huat_im/hong_im_hu_ho/',
